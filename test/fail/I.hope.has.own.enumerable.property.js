I.do('I.hope().has.own.enumerable.property() :', function (I) {
  ...
  I.hope(worker).has.own.enumerable.property('_id');
  I.hope(worker).has.own.enumerable.property('name');
  I.hope(worker).has.no.own.enumerable.property('salary');
  I.hope(worker).has.own.enumerable.property('age');
