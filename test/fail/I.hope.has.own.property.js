I.do('I.hope().has.own.property() :', function (I) {
  ...
  I.hope(worker).has.no.own.property('_id');
  I.hope(worker).has.own.property('name');
  I.hope(worker).has.no.own.property('salary');
  I.hope(worker).has.own.property('age');

  I.hope(123).has.own.property('any');
  I.hope(123).has.no.own.property('any');
